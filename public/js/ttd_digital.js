...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show signature pad modal when approve button is clicked
    if (btnApprove) {
    ...
    document.getElementById('finalSaveSignature').addEventListener('click', function() {
        ...
        formReview.appendChild(hiddenSignatureInput);
        ...
        formReview.appendChild(hiddenPositionInput);
